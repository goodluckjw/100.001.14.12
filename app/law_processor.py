...
def apply_josa_rule(orig, replaced, josa):
    ...
    elif josa == "란" or josa == "\"란":  # 규칙 13 (따옴표가 있는 경우도 포함)
        if replaced_has_batchim:  # 규칙 13-1
            return f'"{orig}{josa}"을 "{replaced}이{josa[0]}"으로 한다.'
        else:  # 규칙 13-2
            return f'"{orig}"를 "{replaced}"로 한다.'
    
    elif josa == "이란" or josa == "\"이란":  # 규칙 14 (따옴표가 있는 경우도 포함)
        if replaced_has_batchim:
            ...
            return f'"{orig}{josa}"을 "{replaced}{josa[0]}"으로 한다.'
    
    elif josa == "라" or josa == "\"라":  # 규칙 17 (따옴표가 있는 경우도 포함)
        if replaced_has_batchim:  # 규칙 17-1
            return f'"{orig}{josa}"를 "{replaced}이{josa[0]}"로 한다.'
        else:  # 규칙 17-2
            return f'"{orig}"를 "{replaced}"로 한다.'
    
    elif josa == "이라" or josa == "\"이라":  # 규칙 18 (따옴표가 있는 경우도 포함)
        if replaced_has_batchim:
            ...
            return f'"{orig}{josa}"를 "{replaced}{josa[0]}"로 한다.'
                                    ...
                                    if find_word in 줄:
                                        ...
                                        for token in tokens:
                                            if find_word in token:
                                                ...
                                                chunk_map[(chunk, replaced, josa, suffix)].append(location) josa, suffix)].append(location)
